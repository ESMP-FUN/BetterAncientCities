...
class BetterAncientCities : JavaPlugin() {
    ...
    /** The jar name this build is published under. The mc26 and mc263 builds differ here. */
    private fun isOwnJar(name: String): Boolean = name.endsWith(".jar") && !name.contains("-mc")
